 ...
 */
export function pronoun(quidData: Quid, pronounNumber: 0 | 1 | 2 | 3 | 4 | 5): string {
 ...
 */
export function upperCasePronoun(quidData: Quid, pronounNumber: 0 | 1 | 2 | 3 | 4 | 5): string {
 ...
 */
export function isPlural(quidData: Quid, pronounString: string): boolean {
 ...
 */
export function pronounAndPlural(quidData: Quid, pronounNumber: 0 | 1 | 2 | 3 | 4 | 5, string1: string, string2?: string): string {

	const pronounString = pronoun(quidData, pronounNumber);

	if (string2 === undefined) {

		return `${pronounString} ${string1}${isPlural(quidData, pronounString) === false ? 's' : ''}`;
	}
 ...
 */
export function upperCasePronounAndPlural(charaterData: Quid, pronounNumber: 0 | 1 | 2 | 3 | 4 | 5, string1: string, string2?: string): string {
