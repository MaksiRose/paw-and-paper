...
module.exports.sendHugMessage = async (interaction, partnerUserData, partnerCharacterData, referencedMessage) => {
    ...
    if (characterData !== undefined && partnerCharacterData !== undefined) {
        await addFriendshipPoints(referencedMessage, userData, characterData._id, partnerUserData, partnerCharacterData._id);
    }
};
/**
