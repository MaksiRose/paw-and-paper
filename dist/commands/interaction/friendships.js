...
module.exports.sendMessage = async (client, message, argumentsArray, userData) => {
    ...
    const friendshipList = [
        ...new Set(Object.keys(characterData.mentions).concat(...allUsersList.map(u => Object.values(u.characters).filter(c => Object.keys(c.mentions).includes(characterData._id)).map(c => c._id)))),
    ];
