...
async function executeWin(componentArray, message, serverData, userData, partnerUserData, otherUserData, currentUserData, userInjuryObjectPlayer1, userInjuryObjectPlayer2, embedArray, botReply, messageContent) {
    ...
    currentUserData = /** @type {import('../../typedef').ProfileSchema} */ (await profileModel.findOneAndUpdate({ userId: currentUserData.userId }, (/** @type {import('../../typedef').ProfileSchema} */ p) => {
    ...
    if (getHurtChance === 0) {
        ...
        otherUserData = /** @type {import('../../typedef').ProfileSchema} */ (await profileModel.findOneAndUpdate({ userId: otherUserData.userId }, (/** @type {import('../../typedef').ProfileSchema} */ p) => {
