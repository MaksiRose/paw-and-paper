...
module.exports.sendMessage = async (client, message, argumentsArray, userData, serverData, embedArray) => {
    ...
    if (partnerUserData !== null && partnerCharacterData != undefined) {
    ...
    async function shareStory() {
        ...
        if (partnerProfileData.experience >= partnerProfileData.levels * 50) {
            partnerUserData = /** @type {import('../../typedef').ProfileSchema} */ (await profileModel.findOneAndUpdate({ userId: partnerUserData.userId }, (/** @type {import('../../typedef').ProfileSchema} */ p) => {
                // @ts-ignore, since partnerData cant be null and message must be in guild
