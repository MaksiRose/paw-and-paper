                        ...
                        default: {
                            ...
                            inventory: {
                                ...
                                default: {
                                    commonPlants: {
                                        type: 'object',
                                        default: Object.fromEntries([...commonPlantsMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                    uncommonPlants: {
                                        type: 'object',
                                        default: Object.fromEntries([...uncommonPlantsMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                    rarePlants: {
                                        type: 'object',
                                        default: Object.fromEntries([...rarePlantsMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                    specialPlants: {
                                        type: 'object',
                                        default: Object.fromEntries([...specialPlantsMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                    meat: {
                                        type: 'object',
                                        default: Object.fromEntries([...speciesMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                    materials: {
                                        type: 'object',
                                        default: Object.fromEntries([...materialsMap.keys()].sort().map(key => {
                                            return [key, { type: 'number', default: 0 }];
                                        })),
                                    },
                                }
