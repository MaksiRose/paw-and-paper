...
const schema = new constructor.schema({
	...
	saplingObject: { type: ['object', ['any']], default: { exists: false, health: 50, waterCycles: 0, nextWaterTimestamp: null, reminder: false } },
...
const model = new constructor.model('./database/profiles/inactiveProfiles', schema);
