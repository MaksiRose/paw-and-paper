...
const event = {
	...
	async execute(client, message) {
		...
		const allproxyIsDisabled = serverData?.proxysetting?.all?.includes(message.channel.id) || serverData?.proxysetting?.all?.includes('everywhere') || false;
		const autoproxyIsDisabled = serverData?.proxysetting?.auto?.includes(message.channel.id) || serverData?.proxysetting?.auto?.includes('everywhere') || false;
