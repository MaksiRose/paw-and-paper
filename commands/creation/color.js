...
module.exports = {
	...
	async sendMessage(client, message, argumentsArray, profileData) {
		...
		console.log(`\x1b[32m\x1b[0m${message.author.tag} (${message.author.id}): color changed from \x1b[33m${profileData.color} \x1b[0mto \x1b[33m${hexColor} \x1b[0min \x1b[32m${message.guild.name} \x1b[0mat \x1b[3m${new Date().toLocaleString()} \x1b[0m`);
		await profileModel
			.findOneAndUpdate(
