	...
	async hasQuest(message, profileData) {
		...
		if (profileData.hasQuest == true) {
			...
			if (profileData.rank == 'Apprentice') {
				...
				if (species.habitatArray[userSpeciesArrayIndex] == 'warm') {
				...
				if (species.habitatArray[userSpeciesArrayIndex] == 'cold') {
				...
				if (species.habitatArray[userSpeciesArrayIndex] == 'water') {
